...
def process_image():
    """API endpoint to process an image from S3 and return the image with bounding boxes."""
    data = request.json
    ...
    try:
        ...
        return send_file(output_path, mimetype="image/jpeg", as_attachment=True, download_name="output_image.jpg")
